...
my $path = "/services/tv/vdr/etc/plugins/graphTFT/themes/DeepBlue/scripts";
my $inpath0 = "/services/tv/vdr/etc/plugins/graphTFT/themes/DeepBlue/png0";
my $inpath1 = "/services/tv/vdr/etc/plugins/graphTFT/themes/DeepBlue/png1";
my $linkpath = "/services/tv/vdr/etc/plugins/graphTFT/themes/DeepBlue/columnimages";
